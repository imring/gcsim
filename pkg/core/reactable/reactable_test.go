...
// func makeAOEAttack(ele attributes.Element, dur reactions.Durability) *info.AttackEvent {
...
// func makeSTAttack(ele attributes.Element, dur reactions.Durability, trg targets.TargetKey) *info.AttackEvent {
// 	return &info.AttackEvent{
// 		Info: combat.AttackInfo{
// 			Element:    ele,
// 			Durability: dur,
...
// 	r := &Reactable{}
// 	r.Durability[attributes.ElementElectric] = 20
// 	r.reduce(attributes.Electro, 20, 1)
// 	if r.Durability[attributes.ElementElectric] != 0 {
// 		t.Errorf("expecting nil electro balance, got %v", r.Durability[attributes.ElementElectric])
// 	}

// 	// straight up consumption
// 	r.Durability[ElementFire] = 20
...
// 	}
// 	if r.Durability[ElementFire] != 25 {
...
// 	if trg.Durability[attributes.ElementElectric] != 0.8*25 {
// 		t.Errorf("expecting 20 electro, got %v", trg.Durability[attributes.ElementElectric])
// 	}
// 	if trg.DecayRate[attributes.ElementElectric] != 20.0/(6*25+420) {
// 		t.Errorf("expecting %v decay rate, got %v", 1.0/(6*25+420), trg.DecayRate[attributes.ElementElectric])
// 	}
...
// 	// test multiple aura
// 	trg.Durability[attributes.ElementElectric] = 0 // reset from previous test
// 	trg.DecayRate[attributes.ElementElectric] = 0
// 	trg.AttachOrRefill(&info.AttackEvent{
// 		Info: combat.AttackInfo{
// 			Element:    attributes.Electro,
// 			Durability: 50,
...
// 	trg.AttachOrRefill(&info.AttackEvent{
// 		Info: combat.AttackInfo{
// 			Element:    attributes.ElementWater,
// 			Durability: 50,
// 		},
// 	})
// 	trg.AttachOrRefill(&info.AttackEvent{
...
// 	}
// 	// make sure > 0
// 	if trg.Durability[attributes.ElementElectric] < 0 {
// 		t.Errorf("expecting electro not to be 0 yet, got %v", trg.Durability[attributes.ElementElectric])
// 	}
...
// 	trg.Durability[attributes.ElementFrozen] = 50
// 	for i := 0; i < 208; i++ {
// 		trg.Tick()
...
// 	}
// 	// should be > 0 still
// 	if trg.Durability[attributes.ElementFrozen] < 0 {
// 		t.Errorf("expecting frozen not to be 0 yet, got %v", trg.Durability[attributes.ElementFrozen])
// 	}
// 	// 1 more tick and should be gone
// 	trg.Tick()
// 	if trg.Durability[attributes.ElementFrozen] > 0 {
// 		t.Errorf("expecting frozen to be gone, got %v", trg.Durability[attributes.ElementFrozen])
// 	}
...
// 	if trg.DecayRate[attributes.ElementFrozen] < frzDecayCap {
// 		t.Errorf("expecting frozen decay to > cap, got %v", trg.Durability[attributes.ElementFrozen])
// 	}
// 	// 1 more tick to reset decay
// 	trg.Tick()
// 	if trg.DecayRate[attributes.ElementFrozen] > frzDecayCap {
// 		t.Errorf("expecting frozen decay to reset, got %v", trg.Durability[attributes.ElementFrozen])
// 	}
// }
...
// 		ele := attributes.ModifierToElement[attributes.ElementType(i)]
